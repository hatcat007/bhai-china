...
/**
 * /tools 索引页（server）
 * - metadata 服务端生成（20-e：title 双语化；description 保持中文主市场口径 ——
 *   server metadata 不随客户端 locale 切换，为已知限制）
 * - 正文（hero + 卡片网格）由客户端组件渲染，随 locale 中英切换（i18n Round B）
 */
export const metadata: Metadata = {
  title: "免费 AI 工具 · Free AI Tools | Better Human AI",
  description:
  ...
  openGraph: {
    ...
    description:
      "5 个免费 AI 工具：网站 AI 缺口扫描、小红书静奢文案、VIP 异议回复、可持续出处文案、竞品 AI 脆弱性报告。无需注册，每个工具 2 次免费。",
    url: "/tools",
    images: [{ url: "/og-image.jpg", width: 1200, height: 630, alt: "Better Human AI 免费工具 · Free AI tools" }],
  },
  twitter: {
